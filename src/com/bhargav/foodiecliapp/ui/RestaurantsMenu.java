...
public class RestaurantsMenu extends Menu
{
    ...
    public void restaurantDeleteForm() {
        ...
        } catch (RestaurantNotExistsException e) {
    ...
    public void restaurantSearchForm() {
        try {
            ...
            System.out.println("Enter Id");
            String id = scanner.nextLine();
            Optional<Restaurant> restaurant = restaurantController.findRestaurantById(id);
            displayRestaurant(restaurant.orElse(null));
        } catch (RestaurantNotExistsException e) {
            System.out.println(e.getMessage());
            displayMenu();
        }
    ...
    /*
    public void displayMenuItems(String restaurantId) throws RestaurantNotExistsException, DishNotFoundException {
